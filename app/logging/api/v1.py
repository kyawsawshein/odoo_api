...
async def tail_application_logs(
    ...
    try:
        ...
        return LogResponse(lines=log_lines, file=log_file, total_lines=len(log_lines))
...
async def get_available_log_files(current_user: User = Depends(get_current_user)):
    """
