...
class BaseService:
    ...
    def __init__(self, db: AsyncSession, current_user: UserSchema):
        ...
        self.logger = logger.bind(service=self.__class__.__name__, user_id=current_user.id)
    ...
    async def _handle_odoo_error(self, error: Exception, operation: str) -> SyncResponse:
