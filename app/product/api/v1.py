...
# Product Endpoints
@router.post(Route.product, response_model=SyncResponse)
...
@router.get(Route.product, response_model=List[Product])
...
@router.get(Route.product_id, response_model=Product)
...
@router.put(Route.product_id, response_model=SyncResponse)
...
@router.post(Route.product_sync, response_model=SyncResponse)
